...
use mil_std_1553b::{ Field, Message };
use mil_std_1553b_derive::*;
...
impl CustomWord {
    ...
    #[word_field(STATUS_LIGHT,0b1000000000000000)]
    pub fn status_light_on(&self) -> bool {
        Self::STATUS_LIGHT_MASK == 0b1000000000000000
    }

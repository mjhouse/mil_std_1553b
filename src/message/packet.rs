use crate::word::{DataWord,StatusWord,CommandWord};
...
mod tests {
    ...
    #[test]
    fn test_packet_convert_data() {
        let packet = Packet::data([0b01101000,0b01101001]);
        let word = packet.as_data().unwrap();
